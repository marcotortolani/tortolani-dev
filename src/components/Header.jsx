export default function Header() {
  return (
    <header className="z-50 w-full max-w-4xl h-14 mt-6 fixed">
      <div className=" z-0 w-full h-full absolute top-0 border-slate-800 border-[0.5px] border-solid bg-black bg-opacity-30 backdrop-blur-lg drop-shadow-lg rounded-full " />
